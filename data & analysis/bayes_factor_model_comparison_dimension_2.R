...
# save output! ####
save(bf.dimension.main.effects.only, bf.dimension.cp.dimension, bf.dimension.combined.stim_type, bf.dimension.combined.trial_type, bf.dimension.cp.effect, file="bayes-factor-analysis-results-dimension.Rdata")
