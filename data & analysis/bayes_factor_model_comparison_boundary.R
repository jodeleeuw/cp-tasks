...
# save output! ####
save(bf.boundary.main.effects.only, bf.boundary.cp.dimension, bf.boundary.combined.stim_type, bf.boundary.combined.trial_type, bf.boundary.cp.effect, file="data & analysis/export-data/bayes-factor-analysis-results-boundary.Rdata")
